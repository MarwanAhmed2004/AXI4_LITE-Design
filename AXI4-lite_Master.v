module AXI4_Lite_Master #(parameter  DAT_PAR = 32 )(
    ...
    input [DAT_PAR-1:0] RDATA ;
    output [DAT_PAR-1:0] WDATA ;
    output [3:0]  WSTRB ;
    ...
    AXI_Lite_Slave #(DAT_PAR) slave1 (.ARADDR_SLAVE(ARADDR) , .AWADDR_SLAVE(AWADDR) , .WDATA_SLAVE(WDATA) , .WSTRB_SLAVE(WSTRB) , .ARVALID_SLAVE(ARVALID) , .RRESP_SLAVE(RRESP) ,
