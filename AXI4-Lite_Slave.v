module AXI_Lite_Slave #(parameter  DAT_PAR = 32 )(
    ...
    reg cs , ns ;
    AXI4_Lite_Ram #(DAT_PAR) ram (.ARADDR_RAM(ARADDR_SLAVE) , .AWADDR_RAM(AWADDR_SLAVE) , .WDATA_RAM(W_TEMP) , .ACLK_RAM(ACLK_SLAVE) ,
